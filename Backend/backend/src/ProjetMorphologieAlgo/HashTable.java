...
public class HashTable {
    ...
    // ========== TRANSFORMATIONS ==========
    public String transformer(String verbe, String scheme, ABRTree arbre) {
 ...
 // Transformation multiple
    public List<String> transformer(String verbe, String[] schemes, ABRTree arbre) {
        List<String> resultats = new ArrayList<>();

        for (String scheme : schemes) {
            String resultat = this.transformer(verbe, scheme, arbre);
            if (!resultat.isEmpty()) {
